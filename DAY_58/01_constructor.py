...
# init is one of the reserved functions in Python. In Object Oriented
# Programming, it is known as a constructor. We can also create
# constructor by defining the function name with same class name.
