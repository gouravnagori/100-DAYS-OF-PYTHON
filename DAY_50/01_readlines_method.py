...
# The readline0 method reads a single line from the file. If we want
# to read multiple lines, we can use a loop.
...
# The readlines0 method reads all the lines of the file and returns
